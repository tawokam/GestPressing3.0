...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 04 fév. 2025 à 11:43
...
(3, 'domguia flore', 699388115, '2025-01-19', 'achille', 1);
...
(4, 3, 2, 2, 'noir avec les taches blanches', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-02', 3, 1, '12:31:53'),
(5, 3, 2, 2, 'autre chaussure', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-04', 4, 1, '08:50:18');
...
(9, 'achille tawokam', 696170179, 'achille', 'b5f9c2073b93dc345fe375e504086b1c', 'admin', 'activer', '0000-00-00', 1, '2025-01-08', '', '', '', 'BTS', '', 'CDD', NULL, NULL, 'Receptionniste', NULL, 'logo1.jpg'),
...
(19, 'TAWOKAM ACHILLE SYLVAIN', 672222260, 'moi', '8f8ad28dd6debff410e630ae13436709', 'simple', 'activer', '2025-01-19', 1, '2001-03-16', 'AZIDFEDHCHEZSHEYUUSO', 'KENMOGNE%20EMMANUEL', 'YIMDJO%20ALBERTINE', 'BTS%20', 'CAMEROUNAIS', 'CDI', '2025-01-19', 'Assurer%20la%20reception%20et%20l&#039;enregistrement%20des%20vetements', 'Receptionniste', 600000, '');
...
(4, 3, 2, 2, 'noir avec les taches blanches', 700, 1400, '2025-02-01', '2025-02-01', 'achille', '2025-02-02', 3, 1);
...
(2, 3, 2, 2, 'noir avec les taches blanches', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-02', 3, 1),
(3, 3, 2, 2, 'noir avec les taches blanches', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-02', 3, 1),
(4, 3, 2, 2, 'noir avec les taches blanches', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-02', 3, 1),
(5, 3, 2, 2, 'noir avec les taches blanches', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-02', 3, 1),
(6, 3, 2, 2, 'noir avec les taches blanches', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-02', 3, 1),
(7, 3, 2, 2, 'noir avec les taches blanches', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-02', 3, 1),
(8, 3, 2, 2, 'noir avec les taches blanches', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-02', 3, 1),
(9, 3, 2, 2, 'noir avec les taches blanches', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-02', 3, 1),
(10, 3, 2, 2, 'noir avec les taches blanches', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-02', 3, 1),
(11, 3, 2, 2, 'noir avec les taches blanches', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-02', 3, 1),
(12, 3, 2, 2, 'noir avec les taches blanches', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-02', 3, 1),
(13, 3, 2, 2, 'noir avec les taches blanches', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-02', 3, 1),
(25, 3, 2, 2, 'noir avec les taches blanches', 700, 1400, '2025-02-01', '2025-02-01', 'achille', '2025-02-03', 3, 1),
(64, 3, 2, 2, 'autre chaussure', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-04', 4, 1);
...
(3, 1400, 1000, 400, 3, '2025-02-01', '2025-02-04', 3, 1),
(4, 1400, 1400, 0, 4, '2025-02-01', '2025-02-04', 3, 1);
...
(1, 'TEST SMS', 699388115, 3, 1, 'achille'),
(2, 'TEST SMS', 699388115, 3, 1, 'achille'),
(3, 'TEST SMS', 699388115, 3, 1, 'achille'),
(4, 'TEST SMS', 699388115, 3, 1, 'achille'),
(5, 'TEST SMS', 699388115, 3, 1, 'achille'),
(6, 'TEST SMS', 699388115, 3, 1, 'achille'),
(7, 'TEST SMS', 699388115, 3, 1, 'achille'),
(8, 'TEST SMS', 699388115, 3, 1, 'achille'),
(9, 'TEST SMS', 699388115, 3, 1, 'achille'),
(10, 'TEST SMS', 699388115, 3, 1, 'achille'),
(11, 'TEST SMS', 699388115, 3, 1, 'achille'),
(12, 'TEST SMS', 699388115, 3, 1, 'achille'),
(13, 'TEST SMS', 699388115, 3, 1, 'achille'),
(14, 'UN AUTRE TEST SMS', 699388115, 3, 1, 'achille'),
(15, 'UN AUTRE TEST SMS', 699388115, 3, 1, 'achille'),
(16, 'UN AUTRE TEST SMS', 699388115, 3, 1, 'achille'),
(17, 'UN AUTRE TEST SMS', 699388115, 3, 1, 'achille'),
(18, 'UN AUTRE TEST SMS', 699388115, 3, 1, 'achille'),
(19, 'UN AUTRE TEST SMS', 699388115, 3, 1, 'achille'),
(20, 'UN AUTRE TEST SMS', 699388115, 3, 1, 'achille'),
(21, 'UN AUTRE TEST SMS', 699388115, 3, 1, 'achille'),
(22, 'UN AUTRE TEST SMS', 699388115, 3, 1, 'achille'),
(23, 'UN AUTRE TEST SMS', 699388115, 3, 1, 'achille'),
(24, '', 699388115, 3, 1, 'achille'),
(25, '', 699388115, 3, 1, 'achille'),
(26, 'La date de retrait de vos vetement est depassé veuillez passer les récupérer SVP', 699388115, 3, 1, 'achille'),
(27, 'Test', 699388115, 3, 1, 'achille');
...
(38, '2025-02-01 08:52:20', 'achille tawokam', 'Client', 'Modification', 'nom:domguia flore, téléphone:699388115', 1),
(39, '2025-02-01 08:52:37', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:TEST SMS', 1),
(40, '2025-02-01 08:53:40', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:TEST SMS', 1),
(41, '2025-02-01 08:55:43', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:TEST SMS', 1),
(42, '2025-02-01 08:57:03', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:TEST SMS', 1),
(43, '2025-02-01 09:06:27', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:TEST SMS', 1),
(44, '2025-02-01 09:08:23', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:TEST SMS', 1),
(45, '2025-02-01 09:11:05', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:TEST SMS', 1),
(46, '2025-02-01 09:14:23', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:TEST SMS', 1),
(47, '2025-02-01 09:14:48', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:TEST SMS', 1),
(48, '2025-02-01 09:15:30', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:TEST SMS', 1),
(49, '2025-02-01 09:17:56', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:TEST SMS', 1),
(50, '2025-02-01 09:20:40', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:TEST SMS', 1),
(51, '2025-02-01 09:21:40', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:TEST SMS', 1),
(52, '2025-02-02 12:35:02', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:UN AUTRE TEST SMS', 1),
(53, '2025-02-02 12:36:26', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:UN AUTRE TEST SMS', 1),
(54, '2025-02-02 12:41:30', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:UN AUTRE TEST SMS', 1),
(55, '2025-02-02 12:42:58', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:UN AUTRE TEST SMS', 1),
(56, '2025-02-02 12:43:13', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:UN AUTRE TEST SMS', 1),
(57, '2025-02-02 12:44:34', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:UN AUTRE TEST SMS', 1),
(58, '2025-02-02 12:44:50', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:UN AUTRE TEST SMS', 1),
(59, '2025-02-02 01:40:20', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:UN AUTRE TEST SMS', 1),
(60, '2025-02-02 01:40:49', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:UN AUTRE TEST SMS', 1),
(61, '2025-02-02 01:42:34', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:UN AUTRE TEST SMS', 1),
(62, '2025-02-02 01:47:00', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:UN AUTRE TEST SMS', 1),
(63, '2025-02-02 01:47:35', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:UN AUTRE TEST SMS', 1),
(64, '2025-02-02 02:00:49', 'achille tawokam', 'Message', 'Envoi de message en masse', 'Envoi aux clients pour informé que la date de retrait est depassé, sms:La date de retrait de vos vetement est depassé veuillez passer les récupérer SVP', 1),
(65, '2025-02-02 02:00:53', 'achille tawokam', 'Message', 'Envoi de message en masse', 'Envoi aux clients pour informé que la date de retrait est depassé, sms:La date de retrait de vos vetement est depassé veuillez passer les récupérer SVP', 1),
(66, '2025-02-02 02:01:32', 'achille tawokam', 'Message', 'Envoi de message en masse', 'Envoi aux clients pour informé que la date de retrait est depassé, sms:La date de retrait de vos vetement est depassé veuillez passer les récupérer SVP', 1),
(67, '2025-02-03 01:04:17', 'achille tawokam', 'Message', 'Envoi de message', 'Envoi d\'un sms a :domguia flore, message:Test', 1),
(68, '2025-02-04 09:35:59', 'achille tawokam', 'facture', 'Reglement facture', 'code facture :4, Montant versé:1000', 1),
(69, '2025-02-04 09:36:01', 'achille tawokam', ' code facture:4, Sortie vetement', 'Insertion', 'quantité:2, description:autre chaussure, montant a versé:700, montant total:1400, date depot:2025-02-01, date retrait:2025-02-04', 1);
...
(3, 1000, 'OUI', 'NON', '2025-02-04', 4, 1),
(4, 400, 'NON', 'OUI', '2025-02-04', 3, 1);
...
(4, 3, 2, 2, 'autre chaussure', 700, 1400, '2025-02-01', '2025-02-04', 'achille', '2025-02-04', 4, 5, 1);
...
(7, 3, 1000, '2025-02-01', 1),
(8, 4, 400, '2025-02-01', 1),
(9, 4, 1000, '2025-02-04', 1);
...
--
ALTER TABLE `depotvetement`
  MODIFY `id_depot` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `dispovetement`
--
ALTER TABLE `dispovetement`
  MODIFY `id_depot` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `message`
  MODIFY `ligne` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT pour la table `nosendsms`
--
ALTER TABLE `nosendsms`
  MODIFY `ligne` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT pour la table `operationseffectuees`
--
ALTER TABLE `operationseffectuees`
  MODIFY `ligne` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `sortivetement`
  MODIFY `id_sort` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `versement`
  MODIFY `id_verse` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
