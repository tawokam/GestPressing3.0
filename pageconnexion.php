                        ...
                        if($nbrel==1 && $statutl=='activer'){
                            ...
                            if($siag = $connec -> query($sia)){
                                ...
                                if($nbrAg == 0){
                                    ...
                                    // activation du pressing sélectionné
                                    $up = "UPDATE agence SET statut='desactiver'";
                                    if($upp = $connecLine -> query($up) ){
                                        $up2="UPDATE agence SET statut='activer' WHERE id_agence='$pressing'";$upp2=$connecLine -> query($up2); // activation en ligne
                                        $up2="UPDATE agence SET statut='activer' WHERE id_agence='$pressing'";$upp2=$connec -> query($up2); // activation en local
                                    }
